About dedupe-variable-datetime
==============================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dedupe-variable-datetime-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14714&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dedupe-variable-datetime-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dedupe-variable-datetime` can be installed with:

```
conda install dedupe-variable-datetime
```

It is possible to list all of the versions of `dedupe-variable-datetime` available on your platform with:
